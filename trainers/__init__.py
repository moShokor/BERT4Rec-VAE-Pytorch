...
def trainer_factory(args, model, train_loader, val_loader, test_loader, export_root, smap):
    trainer = TRAINERS[args.trainer_code]
    return trainer(args, model, train_loader, val_loader, test_loader, export_root, smap)
